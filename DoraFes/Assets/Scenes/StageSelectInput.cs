...
public class StageSelectInput : MonoBehaviour
{
    ...
    void CheakInputKey()
    {
        if (Input.GetKey(KeyCode.D)) isBottom = IsInputBottom.STICK_H_P;
        else if (Input.GetKey(KeyCode.A)) isBottom = IsInputBottom.STICK_H_N;
        else if (Input.GetKey(KeyCode.W)) isBottom = IsInputBottom.STICK_V_P;
        else if (Input.GetKey(KeyCode.S)) isBottom = IsInputBottom.STICK_V_N;
        else if (Input.GetKey(KeyCode.Space)) isBottom = IsInputBottom.A;
        else if (Input.GetKey(KeyCode.B)) isBottom = IsInputBottom.B;
        else if (Input.GetKey(KeyCode.Q)) isBottom = IsInputBottom.L;
        else if (Input.GetKey(KeyCode.E)) isBottom = IsInputBottom.R;
    }
}